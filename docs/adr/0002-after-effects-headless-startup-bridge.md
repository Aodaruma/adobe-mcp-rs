...
- Status: accepted（Windows AE 2026確認済み、実機matrix完了まではpreview）
- Date: 2026-07-15
- Issue: #22
...
2026-07-15にWindows版After Effects 2026（26.2.1x2）で、panelなしcold-start、daemon-first / host-first、raw JSX、retained result、daemon再起動後の再接続、32秒間のheartbeat、normal shutdownを確認した。詳細は [After Effects bridge lifecycle](../after-effects-bridge-lifecycle.md) を参照する。AE 2023–2025、macOS、sleep/resume、modal dialog、複数versionは未確認のためIssue #22は継続する。

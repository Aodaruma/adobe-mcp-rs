...
- 最終更新: 2026-06-25
- 対象OS: Windows / macOS
- 対象: Rust版 `ae-mcp` / `pr-mcp` / `ps-mcp` を Codex のカスタムMCPサーバーとして使う

## 1. 前提

1. Adobe After Effects（2022以降推奨）、Premiere Pro、Photoshop のうち操作対象のアプリ
2. Rust（stable）と Cargo
3. After Effects は `mcp-bridge-auto.jsx`、Premiere Pro / Photoshop は UXP bridge panel を開けること
...
### 6.1 Premiere Pro / Photoshop の UXP bridge
